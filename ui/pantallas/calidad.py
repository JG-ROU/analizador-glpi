...
class PanelEvaluacion(QWidget):
    ...
    def __init__(self, estado, al_guardar=None, padre=None):
        ...
        caja_notas.setMinimumWidth(240)
...
class PantallaCalidad(QWidget):
    ...
    def _crear_evaluar(self) -> QWidget:
        ...
        # Con desplazamiento, la muestra puede estrecharse en pantallas de 1366 px
        desplazable = QScrollArea()
        desplazable.setWidgetResizable(True)
        desplazable.setFrameShape(QScrollArea.Shape.NoFrame)
        desplazable.setWidget(izquierda)
        desplazable.setMinimumWidth(260)
        divisor = QSplitter()
